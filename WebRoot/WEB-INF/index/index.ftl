<div class="clear-margin content">
            ...
            <div class="item clearfix">
                ...
                <div class="row far-top clearfix">
                    <div class="col-md-4 clearfix pull-left">
                        <div class="panel tag">
                        ...
                        <div class="panel tag">
                            <div class="panel-body easypiechart-panel">
                                <h4 class="text-info">请假率</h4>
                                <div class="easypiechart" id="easypiechart-orange" data-percent="82">
                                    <span class="percent">82%</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel tag">
                            <div class="panel-body easypiechart-panel">
                                <h4 class="text-info">请假率</h4>
                                <div class="easypiechart" id="easypiechart-teal" data-percent="82">
                                    <span class="percent">82%</span>
                                </div>
                            </div>
                        </div>
